...
// Taken from team 16481 RoboRacers
public class Vision {
    private final AprilTagProcessor aprilTagProcessor;
    private final VisionPortal portal;
    private final Vector2d cameraOffset = new Vector2d(3.0, 3.0);
...
//                .setTagLibrary(AprilTagGameDatabase.getCurrentGameTagLibrary())
     ...
     * @return Field-Centric Pose of bot.
     */
    public Vector2d getFCPosition(AprilTagDetection detection, double heading) {
    ...
    public Vector2d getFCPosition2(AprilTagDetection detection, double heading) {
        // get coordinates of the robot in RC coordinates
        // ensure offsets are RC
        double x = detection.ftcPose.x-cameraOffset.getX();
        double y = detection.ftcPose.y-cameraOffset.getY();
